...
alias de='if [ $(hostname) = "duivenkracht" ]; then echo "$(tput setaf 1)$(tput bold)You are already on duivenkracht, you fool"!"$(tput sgr0)"; else echo "$(tput setaf 4)$(tput bold)Going on Pidgeon Power—duivenkracht!$(tput sgr0)"; ssh -A -X -t -p 20022 duivenkracht.ytec.nl ". ~/projects/ytec-tooling/empower.sh; bash"; fi'
