...
myloadwidget = awful.widget.watch('awesome.loadavg', 1);
myclipboardwidget = awful.widget.watch('awesome.clipboard', 1, function(widget, stdout)
    widget:set_markup_silently(stdout)
end
);
myvpnwidget = awful.widget.watch('awesome.vpn', 1);
